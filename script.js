...
window.addEventListener('load', function() {
    ...
    // Set resume button href (placeholder - replace with actual resume URL)
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            const templateParams = {
                ...
                to_email: 'mohamedfarhan15029@gmail.com' // Your email address
            };
            ...
            emailjs.send(EMAILJS_SERVICE_ID, EMAILJS_TEMPLATE_ID, templateParams)
                ...
                .catch(function(error) {
                    ...
                    if (EMAILJS_SERVICE_ID === 'YOUR_SERVICE_ID') {
                        showFormMessage('⚠ Please configure EmailJS credentials first. See console for details.', 'error');
                    } else {
